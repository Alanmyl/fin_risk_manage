...
#risk1 = risk_opt_stck('VaR', 0.95, 'put', 0.08, est_gbm_win(5, stock), risk_free, options['volat'])
...
a = risk_hist('VaR', 0.95, 3, logrtn(stock.adj_close))"""
b = hedge_delta('long', 0, risk_free, options['volat'], 5 / 252)
print(b)
