...
files = [pre_data(con.path+'data/'+path)
         for path in os.listdir(con.path+'data/')]
...
print(dt.datetime.now())
bstest = backtest_stock('long', files[0])
print(compare_backtest(bstest, risk_gbm('VaR', 0.95, para), 1))
